...
namespace WoohooDX12
{
  ...
  const uint32* StaticBufferHeap::GetMemorySize() { return &m_memorySize; }
  ...
  bool StaticBufferHeap::AllocVertexBuffer(uint32 numOfVertices,
  ...
  bool StaticBufferHeap::AllocIndexBuffer(uint32 numOfIndices,
                                          uint32 strideInBytes,
                                          void* bufferData,
  ...
  bool StaticBufferHeap::AllocConstantBuffer(uint32 numOfElements,
                                             uint32 strideInBytes,
                                             void* bufferData,
  ...
  bool StaticBufferHeap::AllocBuffer(uint32 numOfElements,
                                     uint32 stride,
                                     void* bufferData,
                                     D3D12_GPU_VIRTUAL_ADDRESS* bufferLocationOut,
                                     uint32* sizeOut)
